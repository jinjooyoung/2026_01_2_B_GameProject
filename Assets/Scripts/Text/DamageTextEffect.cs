...
public class DamageTextEffect : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (textMesh != null)
        {
            ...
            moveDir = new Vector2(randomX, randomY).normalized;     // 랜덤 방향 결정
        }
    ...
    void Update()
    {
        ...
        if (useGravity)
        {
            ...
            rectTransform.anchoredPosition += new Vector2(moveDir.x * moveSpeed * Time.deltaTime, 0);
        }
        else
        {
            rectTransform.anchoredPosition += (Vector2)(moveDir * moveSpeed * Time.deltaTime);      // 직선 이동
        }
